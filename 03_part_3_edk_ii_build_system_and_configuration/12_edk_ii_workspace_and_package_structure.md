# EDK II Workspace 與 Package 結構

> 狀態：Draft
> 文件用途：本檔為章節撰寫大綱，內容、規格版本與平台資料仍需由章節負責人補充及驗證。

## 1. 文件目的
- 說明「EDK II Workspace 與 Package 結構」在 EDK II、建置系統與設定資料 中的角色。
- 定義本章涵蓋範圍、非涵蓋範圍與預期讀者。
...
### 3.1 Workspace、PACKAGES_PATH 與來源樹配置

### 3.2 Package、Module、Library、Application 的組織方式

### 3.3 MdePkg、MdeModulePkg 與平台 Package 的責任

### 3.4 DEC／DSC／INF／FDF 的引用關係

### 3.5 Binary Package 與原始碼 Package 管理

### 3.6 Submodule、Patch、Tag 與版本固定方式

### 3.7 模組定位、相依追蹤與建置產物查找
