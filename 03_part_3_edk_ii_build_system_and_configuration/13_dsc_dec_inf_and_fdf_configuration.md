# DSC、DEC、INF 與 FDF 設定

> 狀態：Draft
> 文件用途：本檔為章節撰寫大綱，內容、規格版本與平台資料仍需由章節負責人補充及驗證。

## 1. 文件目的
- 說明「DSC、DEC、INF 與 FDF 設定」在 EDK II、建置系統與設定資料 中的角色。
- 定義本章涵蓋範圍、非涵蓋範圍與預期讀者。
...
## 3. 建議內容大綱
### 3.1 四類描述檔的責任與互相引用
### 3.2 Package、Library Class 與 Module 宣告
### 3.3 PcdsFixed、Dynamic、FeatureFlag 等 PCD 類型
### 3.4 Library Instance Resolution
### 3.5 Build Option、Depex 與 Architectural Module
### 3.6 FDF Region、FV、FILE 與 SECTION
### 3.7 常見語法錯誤與建置診斷
