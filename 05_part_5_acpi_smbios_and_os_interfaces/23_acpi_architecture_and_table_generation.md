...
## 1. 文件目的
- 說明「ACPI 架構與 Table 產生流程」在 ACPI、SMBIOS 與作業系統介面 中的角色。
- 定義本章涵蓋範圍、非涵蓋範圍與預期讀者。
...
## 3. 建議內容大綱
### 3.1 RSDP、XSDT/RSDT 與 Table Discovery
### 3.2 FADT、MADT、MCFG、SRAT、SLIT 等核心表格
### 3.3 EDK II ACPI Table 安裝流程
### 3.4 Fixed Table 與 Dynamic Table 的資料來源
### 3.5 OEM ID、Revision、Checksum 與版本管理
### 3.6 OS 驗證工具與 Table Dump
### 3.7 跨 SKU、CPU 數量與記憶體配置差異
