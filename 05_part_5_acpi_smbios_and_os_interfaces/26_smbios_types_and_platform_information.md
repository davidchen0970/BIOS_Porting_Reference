...
## 1. 文件目的
- 說明「SMBIOS Type 與平台資訊」在 ACPI、SMBIOS 與作業系統介面 中的角色。
- 定義本章涵蓋範圍、非涵蓋範圍與預期讀者。
...
### 3.1 SMBIOS Entry Point、版本與 Table 結構

### 3.2 Type 0／1／2／3 的韌體與平台識別資料

### 3.3 CPU、Memory、Slot、Onboard Device 等常用 Type

### 3.4 資料來源：Silicon、SPD、FRU、BMC 與 Provisioning

### 3.5 Handle、String、Instance 與多 Socket／多 DIMM 建模

### 3.6 SKU 差異、缺省值與敏感資料處理

### 3.7 dmidecode／OS API 驗證與版本相容性
