# BIOS Image、Region 與 Flash Layout

> 狀態：Draft
> 文件用途：本檔為章節撰寫大綱，內容、規格版本與平台資料仍需由章節負責人補充及驗證。

## 1. 文件目的
- 說明「BIOS Image、Region 與 Flash Layout」在 韌體更新、復原與維護 中的角色。
- 定義本章涵蓋範圍、非涵蓋範圍與預期讀者。
...
## 3. 建議內容大綱
### 3.1 Flash Descriptor 與 BIOS/ME/EC/GbE Region
### 3.2 BIOS Region 內 FV、NVRAM 與 Recovery 區域
### 3.3 Flash Block、Erase Granularity 與 Alignment
### 3.4 讀寫權限、鎖定與 Protected Range
### 3.5 映像檔版本資訊、簽章與 Metadata
### 3.6 容量預算、Recovery 空間及備援映像
### 3.7 Layout 變更的升級相容性風險
