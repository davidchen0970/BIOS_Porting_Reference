# NVRAM Migration、設定保留與版本相容性

> 狀態：Draft
> 文件用途：本檔為章節撰寫大綱，內容、規格版本與平台資料仍需由章節負責人補充及驗證。

## 1. 文件目的
- 說明「NVRAM Migration、設定保留與版本相容性」在 韌體更新、復原與維護 中的角色。
- 定義本章涵蓋範圍、非涵蓋範圍與預期讀者。
...
### 3.1 Setup Schema、Variable Revision 與相容性契約

### 3.2 保留、重設、轉換與淘汰欄位分類

### 3.3 舊版到新版的 Migration 執行時機

### 3.4 Default Store、User Setting 與 Manufacturing Data 優先序

### 3.5 Variable Store 空間、FTW 與失敗交易回復

### 3.6 降版、跨大版本及跳版更新行為

### 3.7 Migration Log、Golden Data 與矩陣測試
