# Manufacturing Mode、Factory Tool 與產線流程

> 狀態：Draft
> 文件用途：本檔為章節撰寫大綱，內容、規格版本與平台資料仍需由章節負責人補充及驗證。

## 1. 文件目的
- 說明「Manufacturing Mode、Factory Tool 與產線流程」在 製造、量產與平台特定筆記 中的角色。
- 定義本章涵蓋範圍、非涵蓋範圍與預期讀者。
...
### 3.1 Manufacturing Mode 進入、退出與權限控制

### 3.2 工站流程、工具版本與映像檔選擇

### 3.3 硬體檢測、壓力測試與結果上傳

### 3.4 序號、MAC、UUID、金鑰與校正資料寫入

### 3.5 燒錄、驗證、鎖定與 Secure Boot Provisioning

### 3.6 失敗重工、換板、清除與稽核紀錄

### 3.7 出站條件及由製造模式轉為使用者模式
