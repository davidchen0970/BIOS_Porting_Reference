# Board ID、SKU、FRU 與平台辨識

> 狀態：Draft
> 文件用途：本檔為章節撰寫大綱，內容、規格版本與平台資料仍需由章節負責人補充及驗證。

## 1. 文件目的
- 說明「Board ID、SKU、FRU 與平台辨識」在 製造、量產與平台特定筆記 中的角色。
- 定義本章涵蓋範圍、非涵蓋範圍與預期讀者。
...
### 3.1 Board ID、FAB、SKU、Bom ID 與 Revision 編碼

### 3.2 Strap、GPIO、EEPROM、FRU 與 BMC 資料來源

### 3.3 偵測時機、優先序與衝突處理

### 3.4 平台設定、GPIO Table、Feature 與映像選擇
