# MAC、Serial Number、UUID 與 Provisioning

> 狀態：Draft
> 文件用途：本檔為章節撰寫大綱，內容、規格版本與平台資料仍需由章節負責人補充及驗證。

## 1. 文件目的
- 說明「MAC、Serial Number、UUID 與 Provisioning」在 製造、量產與平台特定筆記 中的角色。
- 定義本章涵蓋範圍、非涵蓋範圍與預期讀者。
...
### 3.1 MAC、Serial Number、UUID 與資產資料來源

### 3.2 格式、命名空間、唯一性與保留值規則

### 3.3 工廠寫入流程、介面、權限與驗證

### 3.4 BIOS Variable、SMBIOS、FRU、EEPROM 的資料同步

### 3.5 重工、換板、清除與重新 Provisioning
